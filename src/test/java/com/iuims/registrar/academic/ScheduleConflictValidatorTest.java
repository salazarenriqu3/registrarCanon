...
class ScheduleConflictValidatorTest {
    ...
    void setUp() {
        ...
        db.update("INSERT INTO courses VALUES (13, 3, 0, NULL)");
        ...
        db.update("INSERT INTO class_sections VALUES (1, 10, 'BSIT-1-A', 100, 11)");
        db.update("INSERT INTO class_sections VALUES (2, 10, 'BSIT-1-B', 200, 12)");
        db.update("INSERT INTO class_sections VALUES (3, 20, 'BSIT-1-C', 100, 11)");
        db.update("INSERT INTO class_sections VALUES (4, 10, 'BSIT-1-D', NULL, 12)");
        db.update("INSERT INTO class_sections VALUES (5, 10, 'BSIT-1-E', 300, 13)");
    ...
    void capsTheConflictPreviewBeforeItReachesThePage() {
        db.update("INSERT INTO class_sections VALUES (6, 10, 'BSIT-1-F', 100, 11)");
