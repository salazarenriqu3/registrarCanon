...
class AcademicGradingServiceGradingWindowTest {
    ...
    void updateSettingsWithGradingTermIdSavesTermSpecificRowsWithoutChangingGlobalFallback() {
        ...
        assertThat(selectedTerm.get("MIDTERM_EXAM_DATE")).isEqualTo("2026-07-20");
        assertThat(selectedTerm.get("MIDTERM_EXAM_DATE_SOURCE")).isEqualTo("TERM");
