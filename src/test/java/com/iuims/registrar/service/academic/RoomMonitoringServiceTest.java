...
class RoomMonitoringServiceTest {
    ...
    void summarizesRoomUsageConflictsAndIncompleteSchedules() {
        ...
        assertThat(summary.get("used_rooms")).isEqualTo(1);
        assertThat(summary.get("conflict_rooms")).isEqualTo(1);
    ...
    @Test
    void pagesRoomInventoryWithTermScopedAggregateData() {
        RoomMonitoringService.RoomPage page = service.listRoomsForTermPage(20, "IT", "IT Building", null, 1, 1);
        ...
        assertThat(page.rows().get(0))
            .containsEntry("room_code", "IT-301")
            .containsEntry("slot_count", 2L)
            .containsEntry("section_count", 2L)
            .containsEntry("monitor_status", "OK");
    }
