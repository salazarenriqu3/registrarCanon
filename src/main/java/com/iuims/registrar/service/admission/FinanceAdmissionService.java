package com.iuims.registrar.service.admission;
...
public class FinanceAdmissionService {
    ...
    @Value("${registrar.accounts.student-initial-password:}")
    private String configuredStudentInitialPassword;
    ...
    public String approveApplicantAndGenerateStudentId(String refNo, String programCode, int yearLevel) {
        try {
            ...
            String hashedPass = org.mindrot.jbcrypt.BCrypt.hashpw(requiredStudentInitialPassword(), org.mindrot.jbcrypt.BCrypt.gensalt());
    ...
    private String requiredStudentInitialPassword() {
        if (!hasText(configuredStudentInitialPassword)) {
            throw new IllegalStateException(
                "Registrar student initial password is not configured. Set REGISTRAR_STUDENT_INITIAL_PASSWORD or REGISTRAR_TEMP_PASSWORD.");
        }
        return configuredStudentInitialPassword;
    }
    ...
    public Map<String, Object> calculateAssessment(String studentNumber) {
        ...
        double balanceForwardedRemaining = scholarEnrollmentService.getForwardedBalanceRemaining(studentNumber);
        ...
        boolean enlistBlocked = balanceForwardedRemaining >= accountingBlockThreshold;
        ...
        m.put("balance_forwarded_remaining", balanceForwardedRemaining);
        ...
        m.put("balance_forwarded_remaining_fmt", String.format("%,.2f", balanceForwardedRemaining));
