...
public class WithdrawalController {
    ...
    public String dropSubject(@RequestParam String studentNumber,
        ...
        try {
            ...
            ra.addFlashAttribute("errorMessage", "Subject drop was not completed because " + e.getMessage());
        } catch (Exception e) {
        ...
        return redirectToStudentWorkspace(returnTo);
    }
    ...
    public String dropStudent(@RequestParam String studentNumber,
        ...
        try {
            ...
            ra.addFlashAttribute("errorMessage", "Student withdrawal was not completed because " + e.getMessage());
        } catch (Exception e) {
    ...
    public String clearLoadForShift(@RequestParam String studentNumber,
        ...
        try {
            ...
            ra.addFlashAttribute("errorMessage", "Shift load cleanup was not completed because " + e.getMessage());
        } catch (Exception e) {
    ...
    private String redirectToStudentWorkspace(String returnTo) {
        String target = returnTo != null ? returnTo.trim() : "";
        if ("enrollment".equalsIgnoreCase(target)) {
