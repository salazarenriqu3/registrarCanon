...
public class FinancePolicyController {
    ...
    private static final String FINANCE_OWNERSHIP_NOTICE =
        "Finance / Accounting Mirror is read-only in Registrar except for withdrawal-charge settings. Enrollment3 Accounting/Cashier owns the rest of the fee and payment policy authoring.";
    ...
    public String saveRules(@RequestParam Map<String, String> params,
        ...
        ra.addFlashAttribute("successMessage", "Withdrawal charge settings saved.");
        return redirect(installmentTermId);
    }
